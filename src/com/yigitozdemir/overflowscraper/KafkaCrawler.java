...
public class KafkaCrawler {
	public final String URLTemplate = "https://stackoverflow.com/questions/tagged/apache-kafka?tab=votes&page={1}&pagesize=50";
	...
	public static void main(String[] args) {
		int onPage = 1;
		KafkaCrawler runner = new KafkaCrawler();
	...
	private void initialize(KafkaCrawler runner) {
