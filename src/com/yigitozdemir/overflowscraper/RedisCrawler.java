...
public class RedisCrawler {
	public final String URLTemplate = "https://stackoverflow.com/questions/tagged/redis?tab=votes&page={1}&pagesize=50";
	...
	public static void main(String[] args) {
		int onPage = 1;
		RedisCrawler runner = new RedisCrawler();
	...
	private void initialize(RedisCrawler runner) {
