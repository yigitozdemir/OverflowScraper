...
public class RabbitMQCrawler {
	public final String URLTemplate = "https://stackoverflow.com/questions/tagged/rabbitmq?tab=votes&page={1}&pagesize=50";
	public final int MAXIMUM_PAGE = 50;
	public StringBuilder stringBuilder;
	public ArrayList<OverFlowItem> overflowItems;
	public final String CSVPath = "C:\\Users\\010999862\\eclipse-workspace\\RabbitMq.csv";
	
	public static void main(String[] args) {
		int onPage = 1;
		RabbitMQCrawler runner = new RabbitMQCrawler();
	...
	private void initialize(RabbitMQCrawler runner) {
